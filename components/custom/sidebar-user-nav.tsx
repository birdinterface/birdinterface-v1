...
export function SidebarUserNavContent({ user }: { user: ExtendedUser }) {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-4 ${montserrat.className}`}
    >
      ...
      <div className="mb-6">
        ...
        >
          <div
            className={`size-full bg-gray-100 border border-gray-300 rounded-full dark:bg-[#282b2e] dark:border-gray-700`}
          >
            <div
              className={`absolute top-1/2 left-[4px] -translate-y-1/2 bg-[#d3dee8] rounded-full h-6 w-[76px] transition-all ${
                selectedPlan ===
          ...
          <span
            className={`absolute left-0 w-[80px] text-xs font-medium text-gray-700 dark:text-gray-300 transition-opacity duration-200 ease-in ${
              selectedPlan === (currentMembership === "free" ? "free" : "pro")
                ? "opacity-100"
                : "opacity-50"
          ...
          <span
            className={`absolute right-0 w-[80px] text-xs font-medium text-gray-700 dark:text-gray-300 transition-opacity duration-200 ease-in ${
              selectedPlan ===
              (currentMembership === "free" ? "pro" : "ultimate")
                ? "opacity-100"
                : "opacity-50"
      ...
      <div
        className={`w-full sm:w-[400px] border rounded-lg p-4 sm:p-6 flex flex-col bg-white dark:bg-[#000000] ${
          ...
          {selectedPlan === "free" ? (
            <>
              <li className="flex items-center mb-2">
                <svg
                  className="size-5 mr-3 text-black dark:text-white"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
