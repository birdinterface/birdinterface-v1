...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-1 [&_.rdp-nav_button>svg]:h-3 [&_.rdp-nav_button>svg]:w-3 [&_.rdp-nav_button>svg]:text-foreground", className)}
      classNames={{
        ...
        nav_button: "h-1 w-1 bg-transparent p-0 text-foreground hover:text-foreground disabled:opacity-50",
        ...
        day_selected: "text-foreground font-medium bg-transparent hover:bg-transparent focus:bg-transparent",
