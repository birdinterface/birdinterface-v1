...
const PRICING = {
  default: {
    // Assumes grok-3, grok-2-vision-1212 (Update if vision model has different pricing)
...
export const USAGE_LIMITS = {
  free: 0.5, // $0.10 per month
  pro: 60.0, // $3.00 per month
  ultimate: 150.0, // $6.00 per month
} as const
...
export function calculateCost(
  ...
  const pricingTier =
    PRICING[modelName as keyof typeof PRICING] || PRICING.default
